                            ...
                            Wallet.create(address, organization.id)
                                .then(({dataValues: wallet}) => {
                                    ...
                                    let message = {
                                        ...
                                        text: `Você criou uma organização no Blockshare. Você pode acessar este link: ${base_url_frontend}/${organization.id} para concluir o cadastro. Caso não tenha se cadastrado, basta ignorar este e-mail.`,
                                    };
